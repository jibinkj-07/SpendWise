...
class MembersCategoryChart extends StatelessWidget {
  final ValueNotifier<Map<String, List<CategoryChartData>>>
      membersCategoryMapData;
  final Size size;

  const MembersCategoryChart({
    super.key,
    required this.membersCategoryMapData,
    required this.size,
  });
